    ...
    <div className="pt-24 pb-16">
      <div className="container mx-auto px-4">
        <SectionTitle
          ...
          subtitle="Nossa dermatologista certificada combina anos de experiência com educação contínua para oferecer a você o mais alto padrão de atendimento."
        />
        ...
        <div className="mt-16 p-8 bg-white dark:bg-gray-800 rounded-lg shadow-md text-center backdrop-blur-sm bg-opacity-80 dark:bg-opacity-80">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-2xl mx-auto">
            Nossa Especialista está pronta para cuidar da saúde e beleza da sua pele com os tratamentos mais avançados e personalizados.
          </p>
          <a
            href="/contact"
